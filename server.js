...
app.get('/getitem/:id',(req,res)=>{
  ...
  var yuk = JSON.parse(items[i]);
  var na = yuk.name;
  var desc = yuk.descripton;
  var src = yuk.src;
  var cost = yuk.cost;
  
  res.render('shop-details.html',{namee:na,desc:desc,src:src,cost:cost});
});
...
app.get('/payment/:details',(req,res)=>{
  ...
  var orders = {
    "details": JSON.parse(req.params.details),
    "bill": bill,
    "cart":k
  }
